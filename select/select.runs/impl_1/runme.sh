...
HD_PWD='D:/document/Vivado/select/select.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log select.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source select.tcl -notrace
