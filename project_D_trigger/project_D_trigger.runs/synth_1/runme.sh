...
HD_PWD='D:/document/Vivado/project_D_trigger/project_D_trigger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log beat_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source beat_4.tcl
