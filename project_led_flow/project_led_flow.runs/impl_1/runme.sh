...
HD_PWD='C:/Users/Aduan/VivadoPro/project_led_flow/project_led_flow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_led_flow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source final_led_flow.tcl -notrace
