...
HD_PWD='C:/Users/Aduan/VivadoPro/project_led_flow/project_led_flow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_led_flow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_led_flow.tcl
